...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mahasiswaList.add(new Mahasiswa("Nama: Abmi Sukma Edri","Nim: 1205012o0341",R.drawable.amiii));
        ...
        mahasiswaList.add(new Mahasiswa("Nama: Diki Afdol","Nim: 112250110383",R.drawable.a));
        ...
        mahasiswaList.add(new Mahasiswa("Nama: Hafidz Alhadid Rahman","Nim: 12250111794",R.drawable.a));
        ...
        mahasiswaList.add(new Mahasiswa("Nama: Nama: Raka Sabri","Nim: 12250110342",R.drawable.a));
        mahasiswaList.add(new Mahasiswa("Nama: Surya Hidayatullah Firdaus","Nim: 12250111759",R.drawable.surya));
